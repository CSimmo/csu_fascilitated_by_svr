...
class PiObjectDetector(object):
    ...
    def DetectionToDict(self, detection):
        ...
        return {"label": class_name, "confidence": confidence, "startX": startX, "startY": startY, "endX": endX,
                "endY": endY}
...
if __name__ == '__main__':
    ...
    detector = PiObjectDetector(prototxt_path="MobileNetSSD_deploy.prototxt.txt",
